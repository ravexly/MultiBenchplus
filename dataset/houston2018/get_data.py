...
from rs_fusion_datasets import Houston2018Ouc


class MyHouston2018(Houston2018Ouc):
...
def get_loader(batch_size=128):
    trainset = MyHouston2018('train', patch_size=5)
    testset = MyHouston2018('test', patch_size=5)
    train_loader = DataLoader(trainset, batch_size=batch_size, shuffle=True, drop_last=True)
    test_loader = DataLoader(testset, batch_size=512, shuffle=False, drop_last=True)
