...
from rs_fusion_datasets import BerlinOuc


class MyBerlinOuc(BerlinOuc):
...
def get_loader(batch_size=512):
    trainset = MyBerlinOuc('train', patch_size=5)
    testset = MyBerlinOuc('test', patch_size=5)
