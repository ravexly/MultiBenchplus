...
class MMDataset(Dataset):
    def __init__(self, dataset_name, mode, feature_path, use_bert=True, need_data_aligned=True, need_normalized=False):
...
def get_loader(
    dataset_name='SIMS',
    feature_path='../../data/SIMS/Processed/unaligned_39.pkl',
    batch_size=8,
    num_workers=4,
    use_bert=True,
