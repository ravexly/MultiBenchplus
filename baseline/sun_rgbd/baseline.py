...
ROOT, SOURCE_DATASET_DIR, OUTPUT_DIR = setup_baseline_runtime("sun_rgbd", OUTPUT_DIR)
...
def build_encoders():
    ...
    image_encoder2 = ImageEncoder(args).to(device)

    return [image_encoder, image_encoder2]
